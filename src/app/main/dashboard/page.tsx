...
import { ActivitySquare, LucideMail, PanelTopInactive, User, UserPlus } from 'lucide-react';
  ...
  return (
    <div className='w-full'>
      ...
      <div className='text-white flex flex-col gap-2'>
        ...
        <p className='text-gray-300 flex items-center gap-2'><LucideMail className='w-4 h-4' />{session?.user?.email}</p>
      </div>
          ...
          return (
            ...
            >
              <CardHeader className="flex flex-row flex-wrap items-center justify-between">
                ...
                <CardTitle className="text-lg font-bold text-gray-300">{item.title}</CardTitle>
              </CardHeader>
